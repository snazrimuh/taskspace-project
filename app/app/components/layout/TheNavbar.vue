<template>
  <header class="glass-bar h-14 flex items-center justify-between px-6 sticky top-0 z-20">
    ...
    <div class="flex items-center gap-3">
      ...
      <div class="text-sm">
        <span v-if="teamName" class="font-semibold text-slate-700 dark:text-slate-200">{{ teamName }}</span>
        <span v-if="teamName && pageTitle" class="text-slate-400 dark:text-slate-500 mx-1.5">·</span>
    ...
    <div class="flex items-center gap-1">
      ...
      <!-- Notifications -->
      <button class="relative p-2 text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 hover:bg-white/40 dark:hover:bg-white/[0.06] rounded-xl transition-colors">
      ...
      <NuxtLink
        ...
        class="p-2 text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 hover:bg-white/40 dark:hover:bg-white/[0.06] rounded-xl transition-colors"
      >
