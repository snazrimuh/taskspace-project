  ...
  <div class="bg-white dark:bg-[#161b22] rounded-2xl shadow-lg dark:shadow-2xl px-10 py-12 border border-slate-100 dark:border-slate-700/50">
    ...
    <form class="space-y-4" @submit.prevent="handleLogin">
      ...
      <div class="flex justify-end">
        <NuxtLink to="/forgot-password" class="text-sm text-primary-600 dark:text-primary-400 hover:text-primary-700 font-medium">
          Forgot Password?
        </NuxtLink>
      </div>
    ...
    <p class="mt-6 text-center text-sm text-slate-500 dark:text-slate-400">
      ...
      <NuxtLink to="/register" class="text-primary-600 dark:text-primary-400 hover:text-primary-700 font-medium">Sign up</NuxtLink>
    </p>
  </div>
</template>
